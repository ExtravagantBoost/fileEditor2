    ...
    dropdown: (btn1, actions) => {
        ...
        ret.apCh(
            ...
            },
            {
                ...
                type: "button",
                class: "btn btn-outline-file dropdown-toggle dropdown-toggle-split border-start-0",
        ...
        let _p_ = {
            ...
            createPanel: () => {
                ...
                if (!l("#Fe2_Panel")) {
                        ...
                        div: [
                            {
                                div: [
                                    {
                                        button: [
                                            { img: [], src: "./icons/prettier.svg", width: "30px", height: "30px", class: "me-2" },
                                            "Beautify",
                                        ],
                                    ...
                                    {
                                        button: [{ img: [], src: "./icons/terser-icon.png", width: "30px", height: "30px", class: "me-2" }, "Minify"],
                    ...
                    self._p_.panel = bs.offcanvas(title, body, { dark: true, keyboard: false, pos: "end", backdrop: false, scroll: true });
